...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer: The headers are random and there are dots following each row name.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: The headers still don't tell us what we need to know and there are still all the dots after the row names.**
...
**Task** Run the codeblock below. What else do we need to do? **Answer: Now we need to get rid of all the dots.**
