...
```{r echo=FALSE}
census_api_key("b5ef2842eebc88879e41696b9571db09b089f505", install=TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard County (129549)**
...
Is the difference between Calvert and Montgomery significant? **Answer: Not significant**

Is the difference between Howard and everyone else significant? **Answer: Significant**
