...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: The "label=TRUE" part made the months have their actual names instead of just the number of the month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: We see a bar chart for our data grouped by month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The coordinates flipped, or made the columns go sideways instead.**
...
**Task** Run the following code. What do you think this does? **Answer: This saved our chart as a png in the folder.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a chart with each data having a number of calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a line chart for the amount of calls for each date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: It tried to write every single date on the x-axis which makes it unreadable.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Now the dates are at an angle so we can read them more easily.**
