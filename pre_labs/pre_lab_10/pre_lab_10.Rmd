...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: It contains information that draws out the geography for different zip codes in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: We see a map of Maryland by zip code.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: We see the geographic information for every zip code in the country.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Now we only have Maryland counties instead of the entire country.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This map of Maryland counties does not include the Chesapeake Bay.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Now the zip codes are layered over the map of Maryland counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: We have a data set of the number of foreclosures per zip code in Maryland in March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Now we have a data set that has our foreclosure data matched with our geographic data of Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer**: We see a map that has the Maryland zip codes each having a color to show the number of foreclosures in that zip code.
...
**Task** Run the following code. Describe the output in the space below. **Answer: We combined our foreclosure data with our Maryland county population data. This will help us if we want to figure out the percentage of foreclosures in a county according to population.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: The county with the most foreclosures is Charles. It seems like the more northern counties generally have less foreclosures than southern counties.**
