...
notice about the columns? **Answer: Our columns are now just the data
and the news release/news item.**
...
tags there are in the HTML source? **Answer: 20**
...
tags. Describe the output: **Answer: There are 122 items that look like
they are probably pages of the website.**
...
**Answer: We now have a dataframe for all the links.**
