...
**Task** Run the following code and describe the dataframe it outputs. **Answer: It shows us data for each state including the education spending per pupil in 2021, the percentage growth in GDP for 2021, the percentage population change in 2021, and the winner of the state's popular vote in the 2020 presidential election.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: The data points are fairly spread out. It doesn't look like there is a strong correlation here, but the trend line goes slightly up.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: There isn't a strong correlation, but the data points generally move down from left to right, showing a slight negative correlation.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: The correlation between education spending and GDP growth is slightly negative. The correlation between education spending and population change is also negative. The correlation between GDP growth and population change is positive.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: It gives us the strength of the correlation, t test, df, and p-value.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: We see a higher p-value, meaning this correlation may be random.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: We see a table that gives the average GDP growth, education spending per pupil, and population growth for states who voted for Biden and Trump individually.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: We see the p-value and t-value.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: We see the t-value and p-value.**
