...
**Answer: It's important to store it in a new variable so we don't lose any of the columns from the previous data set.**
...
**Answer: The "and" function gave us 231 and the "or" function gave us 41011.**
...
1.  I would like to use mutating and filtering to figure out the percentage of all UMD courses that are journalism courses.

2.   I would like to use mutating and filtering to see what percentage of donations to Wes Moore's campaign came from outside of Maryland.

3.  I would like to see if any counties had a higher percentage of votes for other candidates rather than Moore.
