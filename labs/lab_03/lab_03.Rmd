...
A2: The year with the largest total amount is 2020. I notice that the years listed does not include the year of 2016. Maybe in 2016 the county was listed as something that we did not include in our initial filter.
...
A3. A MORTON THOMAS & ASSOC INC vs. A MORTON THOMAS & ASSOCIATES INC

A&I INC vs. A&I INC.

AEROSOL MONITORING & ANALYSIS INC vs. AERSOL MONITORING & ANALYSIS INC

Maybe there is a way to remove extra spaces or look for typos in the data?
...
A4: I don't see a strong correlation from how the funding for stem cell research has changed over time, as some years it seems to go up and some down. I did notice that the amount of funding in 2009 compared to other years is much higher, so that is interesting.
